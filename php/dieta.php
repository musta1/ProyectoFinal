	              					...
	              					<div class="row">
	                					...
	                					?>
	                				 	<table class="table table-hover">
												    <thead>
												      <tr>
												        <th>  </th>
												        <th style="width: 300rem !important;">Lunes</th>
												        <th style="width: 150rem !important;">Martes</th>
												        <th style="width: 300rem !important;">Miercoles</th>
												        <th style="width: 150rem !important;">Jueves</th>
												        <th style="width: 300rem !important;">Viernes</th>
												      </tr>
												    </thead>
												    <tbody>
										<?php
	                					...
	                					while(($menu=mysqli_fetch_array($resultado2)) && ($cont<5)){
		                					...
		                					while($dieta=mysqli_fetch_array($resultado3)) {
		                						...
		                						if ($dieta['menu_semana']==$semana) {
		                							echo "<br/>-".$dieta['plato_descripcion']."";
		                							?>
		                						<?php
		                						}else{
		                							if ($cont1<0) {
		                						?>
		                								</td><td><?php echo "-".$dieta['plato_descripcion'].""; ?>
		                						<?php
		                							}else{
		                						?>
