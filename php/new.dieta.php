          					...
          					<div class="panel panel-info">
	            				...
	            				<div class="panel-body">
	              					<div class="row">
	                					...
	                					$sql_menu = "SELECT menu_id, menu_comida FROM tbl_menu where dieta_id =(SELECT dietas_id FROM tbl_dietas where cliente_id= (SELECT cliente_id from tbl_cliente where cliente_email='$m'))";
						                  ...
						                  <div class="modal-dialog">
						                    ...
						                    <div class="modal-content">
						                      ...
						                      <div class="modal-body">
						                        <form role="form" action="nuevadireccion.proc.php" method="POST">
										...
										<table class="table table-hover">
											...
											<tbody>
											<?php
											while($menu=mysqli_fetch_array($resultado2)){
	                						$sql_dieta = "SELECT menu_comida, plato_descripcion FROM tbl_menu INNER JOIN tbl_platomenu ON tbl_platomenu.menu_id=tbl_menu.menu_id INNER JOIN tbl_platos ON tbl_platomenu.plato_id=tbl_platos.plato_id WHERE tbl_menu.menu_comida='".$menu['menu_comida']."' AND dieta_id =(SELECT dietas_id FROM tbl_dietas where cliente_id= (SELECT cliente_id from tbl_cliente where cliente_email='$m'))";
	                						 // echo $sql_dieta;
	                						?>

	                						<tr><td><?php echo "". $menu['menu_comida']."" ?></td>
	                						<td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">+</button></td>
	                						<td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">+</button></td>
	                						<td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">+</button></td>
	                						<td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">+</button></td>
	                						<td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">+</button></td>
